...
#include "layer/x86/instancenorm_x86.h"
namespace ncnn { DEFINE_LAYER_CREATOR(InstanceNorm_x86) }
#include "layer/vulkan/instancenorm_vulkan.h"
namespace ncnn { DEFINE_LAYER_CREATOR(InstanceNorm_vulkan) }
#include "layer/x86/instancenorm_x86_avx512.h"
namespace ncnn { DEFINE_LAYER_CREATOR(InstanceNorm_x86_avx512) }
#include "layer/x86/instancenorm_x86_fma.h"
namespace ncnn { DEFINE_LAYER_CREATOR(InstanceNorm_x86_fma) }
#include "layer/x86/instancenorm_x86_avx.h"
namespace ncnn { DEFINE_LAYER_CREATOR(InstanceNorm_x86_avx) }
...
#include "layer/x86/sdpa_x86.h"
namespace ncnn { DEFINE_LAYER_CREATOR(SDPA_x86) }
#include "layer/x86/sdpa_x86_avx512.h"
namespace ncnn { DEFINE_LAYER_CREATOR(SDPA_x86_avx512) }
#include "layer/x86/sdpa_x86_fma.h"
namespace ncnn { DEFINE_LAYER_CREATOR(SDPA_x86_fma) }
#include "layer/x86/sdpa_x86_avx.h"
namespace ncnn { DEFINE_LAYER_CREATOR(SDPA_x86_avx) }
