...
#include "multiheadattention_x86_avx512.h"

#include "layer_type.h"

namespace ncnn {

MultiHeadAttention_x86_avx512::MultiHeadAttention_x86_avx512()
{
#if __SSE2__
...
int MultiHeadAttention_x86_avx512::create_pipeline(const Option& _opt)
{
    Option opt = _opt;
    if (int8_scale_term)
    {
