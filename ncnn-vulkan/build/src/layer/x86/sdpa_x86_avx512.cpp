...
#include "sdpa_x86_avx512.h"

#include "layer_type.h"

namespace ncnn {

SDPA_x86_avx512::SDPA_x86_avx512()
{
    qk_gemm = 0;
    qkv_gemm = 0;
    qk_softmax = 0;
...
int SDPA_x86_avx512::create_pipeline(const Option& _opt)
{
    Option opt = _opt;
    if (int8_scale_term)
    {
...
int SDPA_x86_avx512::destroy_pipeline(const Option& _opt)
{
    Option opt = _opt;
    if (int8_scale_term)
    {
...
int SDPA_x86_avx512::forward(const std::vector<Mat>& bottom_blobs, std::vector<Mat>& top_blobs, const Option& _opt) const
{
    Option opt = _opt;
    if (int8_scale_term)
    {
